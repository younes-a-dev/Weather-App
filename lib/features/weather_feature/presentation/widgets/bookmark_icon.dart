...
import '../../../bookmark_feature/domain/entities/city_entity.dart';
import '../../../bookmark_feature/presentation/bloc/bookmark_bloc.dart';
import '../../../bookmark_feature/presentation/bloc/get_city_status.dart';
import '../../../bookmark_feature/presentation/bloc/save_city_status.dart';
    ...
    return BlocBuilder<BookmarkBloc,BookmarkState>(
      ...
      builder: (context, state){
            ...
            builder: (context, cityState) {
              ...
              if(cityState.saveCityStatus is SaveCityInitial){
                return IconButton(
                  ...
                  icon: Icon(city == null ? Icons.bookmark_border_rounded : Icons.bookmark, color: Colors.yellow,),);
              }
        ...
        if(state.getCityStatus is GetCityError){
          return IconButton(
            onPressed: (){},
            icon: const Icon(Icons.error,color: Colors.red,size: 35),);
        }
